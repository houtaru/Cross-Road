...
const SDL_Rect ScreenMain::RECT_BUTTON_LOADGAME = {
    Constants::SCREEN_WIDTH / 2 - 250 / 2,
...
const SDL_Rect ScreenMain::RECT_BUTTON_QUIT = {
    ...
    RECT_BUTTON_SETTING.y + RECT_BUTTON_SETTING.h + 25,
    250, 60
};
...
ScreenMain::ScreenMain():
    ...
    buttonLoad(new Texture(
        "assets/images/button_loadgame.png",
        RECT_BUTTON_LOADGAME
    )),
    buttonHighscore(new Texture(
        "assets/images/button_highscore.png",
        RECT_BUTTON_HIGHSCORE
    )),
    buttonSetting(new Texture(
        "assets/images/button_setting.png",
        RECT_BUTTON_SETTING
    )),
    buttonQuit(new Texture(
        "assets/images/button_quit.png",
        RECT_BUTTON_QUIT
    ))
{
    background = make_shared<Texture>("assets/images/background.png", RECT_BACKGROUND);
